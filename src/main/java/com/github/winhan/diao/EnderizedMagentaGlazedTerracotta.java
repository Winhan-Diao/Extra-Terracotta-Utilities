        ...
        switch (state.get(FACING)) {
            case NORTH -> {
                if (!world.getBlockState(pos.north()).isAir() && world.getBlockState(pos.south()).isAir()) {
                    ...
                    world.setBlockState(pos.north(), Blocks.AIR.getDefaultState(), Block.NOTIFY_ALL_AND_REDRAW);
            ...
            case SOUTH -> {
                if (!world.getBlockState(pos.south()).isAir() && world.getBlockState(pos.north()).isAir()) {
                    ...
                    world.setBlockState(pos.south(), Blocks.AIR.getDefaultState(), Block.NOTIFY_ALL_AND_REDRAW);
                    world.playSound(null, pos, SoundEvents.ENTITY_ENDERMAN_TELEPORT, SoundCategory.BLOCKS, 1.0F, 1.0F);
                }
            }
            case EAST -> {
                if (!world.getBlockState(pos.east()).isAir() && world.getBlockState(pos.west()).isAir()) {
                    ...
                    world.setBlockState(pos.east(), Blocks.AIR.getDefaultState(), Block.NOTIFY_ALL_AND_REDRAW);
                    world.playSound(null, pos, SoundEvents.ENTITY_ENDERMAN_TELEPORT, SoundCategory.BLOCKS, 1.0F, 1.0F);
                }
            }
            case WEST -> {
                if (!world.getBlockState(pos.west()).isAir() && world.getBlockState(pos.east()).isAir()) {
                    ...
                    world.setBlockState(pos.west(), Blocks.AIR.getDefaultState(), Block.NOTIFY_ALL_AND_REDRAW);
                    world.playSound(null, pos, SoundEvents.ENTITY_ENDERMAN_TELEPORT, SoundCategory.BLOCKS, 1.0F, 1.0F);
                }
            }
            case UP -> {
                if (!world.getBlockState(pos.up()).isAir() && world.getBlockState(pos.down()).isAir()) {
                    ...
                    world.setBlockState(pos.up(), Blocks.AIR.getDefaultState(), Block.NOTIFY_ALL_AND_REDRAW);
                    world.playSound(null, pos, SoundEvents.ENTITY_ENDERMAN_TELEPORT, SoundCategory.BLOCKS, 1.0F, 1.0F);
                }
            }
            case DOWN -> {
